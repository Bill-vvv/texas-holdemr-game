...
import { ERROR_TYPES } from './protocol.js';

// 错误类型常量（使用 protocol.js 中的标准常量）
const LIFECYCLE_ERRORS = {
  ONLY_IN_WAITING_STATE: ERROR_TYPES.ONLY_IN_WAITING_STATE,
  SEAT_TAKEN: ERROR_TYPES.SEAT_TAKEN,
  BUYIN_OUT_OF_RANGE: ERROR_TYPES.BUYIN_OUT_OF_RANGE, 
  ADDON_OVER_MAX: ERROR_TYPES.ADDON_OVER_MAX,
  PLAYER_NOT_SEATED: ERROR_TYPES.PLAYER_NOT_SEATED,
  ALREADY_SEATED: ERROR_TYPES.ALREADY_SEATED,
  NO_SEATS_AVAILABLE: ERROR_TYPES.NO_SEATS_AVAILABLE
};
